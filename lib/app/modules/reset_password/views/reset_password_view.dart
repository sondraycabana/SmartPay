  ...
  Widget build(BuildContext context) {
    return ScreenTypeLayout.builder(
      mobile: (_) => OrientationLayoutBuilder(
        ...
        landscape: (_) =>
            ResetPasswordMobilePortrait(), // replace with landscape view for mobile
      ),
      tablet: (_) => OrientationLayoutBuilder(
        portrait: (_) =>
            ResetPasswordMobilePortrait(), // replace with portrait view for tablet
        landscape: (_) =>
            ResetPasswordMobilePortrait(), // replace with landscape view for tablet
      ),
    );
  }
}
